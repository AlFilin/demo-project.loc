...
class ListByCouponGroupStore extends AbstractStoreWithTwoParam
{
    ...
    {
        $arElementIDList = (array) DB::table('lovata_coupons_shopaholic_group_product')->where('group_id', $this->sValue)->pluck('product_id')->all();
    ...
    {
        $arBrandIDList = (array) DB::table('lovata_coupons_shopaholic_group_brand')->where('group_id', $this->sValue)->pluck('brand_id')->all();
        ...
        $arElementIDList = (array) Product::whereIn('brand_id', $obBrandList->getIDList())->pluck('id')->all();
    ...
    {
        $arCategoryIDList = (array) DB::table('lovata_coupons_shopaholic_group_category')->where('group_id', $this->sValue)->pluck('category_id')->all();
    ...
    protected function getByTagRelation() : array
    {
        ...
        $arTagIDList = (array) DB::table('lovata_coupons_shopaholic_group_tag')->where('group_id', $this->sValue)->pluck('tag_id')->all();
        ...
        $arElementIDList = (array) DB::table('lovata_tagsshopaholic_tag_product')->whereIn('tag_id', $obTagList->getIDList())->pluck('product_id')->all();
